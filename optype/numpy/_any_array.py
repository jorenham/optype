...
class _AnyArrayNP[ST_co: np.generic](Protocol):
    def __len__(self, /) -> int: ...
    def __array__(self, /) -> np.ndarray[AnyShape, np.dtype[ST_co]]: ...


# NOTE: does not include tuple
class _AnyArrayPY0[T_co](Protocol):
    def __len__(self, /) -> int: ...
    def __getitem__(self, i: int, /) -> "T_co | _AnyArrayPY0[T_co]": ...
    def __reversed__(self, /) -> Iterator["T_co | _AnyArrayPY0[T_co]"]: ...
