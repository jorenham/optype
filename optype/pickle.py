...
_Args: TypeAlias = tuple[_ArgT, ...]
_Objects: TypeAlias = tuple[object, ...]
...
_ReduceValue: TypeAlias = (
    str
    | tuple[_AnyCallable, _Objects]
    | tuple[_AnyCallable, _Objects, object]
    | tuple[_AnyCallable, _Objects, object, CanIterSelf[object] | None]
    | tuple[
        _AnyCallable,
        _Objects,
        object,
...
class CanGetnewargsEx(Protocol[_ArgT_co, _ArgT]):
    ...
    def __getnewargs_ex__(self, /) -> tuple[_Args[_ArgT_co], dict[str, _ArgT]]: ...
